...
import { totalMateriales, totalManoObra, cascada, bocasPorTipo, computo } from '../lib/calc';
import { money, hoy } from '../lib/format';
import { numeroALetras, capitalizar } from '../lib/letras';
